...
namespace Hotel {
    ...
    public partial class clientDataSet : global::System.Data.DataSet {
        ...
        public partial class ClientDataTable : global::System.Data.TypedTableBase<ClientRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ClientRow AddClientRow(string FirstName, string SecondName, string Patronymic) {
...
namespace Hotel.clientDataSetTableAdapters {
    ...
    public partial class ClientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Client] WHERE (([Id_Client] = @Original_Id_Client) AND ([First" +
                "Name] = @Original_FirstName) AND ([SecondName] = @Original_SecondName) AND ((@Is" +
                "Null_Patronymic = 1 AND [Patronymic] IS NULL) OR ([Patronymic] = @Original_Patro" +
                "nymic)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Client] SET [FirstName] = @FirstName, [SecondName] = @SecondName, [Patronymic] = @Patronymic WHERE (([Id_Client] = @Original_Id_Client) AND ([FirstName] = @Original_FirstName) AND ([SecondName] = @Original_SecondName) AND ((@IsNull_Patronymic = 1 AND [Patronymic] IS NULL) OR ([Patronymic] = @Original_Patronymic)));
SELECT Id_Client, FirstName, SecondName, Patronymic FROM Client WHERE (Id_Client = @Id_Client)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_Client, FirstName, SecondName, Patronymic FROM dbo.Client";
        ...
        public virtual int Delete(int Original_Id_Client, string Original_FirstName, string Original_SecondName, string Original_Patronymic) {
        ...
        public virtual int Update(string FirstName, string SecondName, string Patronymic, int Original_Id_Client, string Original_FirstName, string Original_SecondName, string Original_Patronymic, int Id_Client) {
            if ((FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string SecondName, string Patronymic, int Original_Id_Client, string Original_FirstName, string Original_SecondName, string Original_Patronymic) {
            return this.Update(FirstName, SecondName, Patronymic, Original_Id_Client, Original_FirstName, Original_SecondName, Original_Patronymic, Original_Id_Client);
        }
    }
